---
description: The Reno Compass 8-stage renovation pipeline orchestration. Trigger to run or resume the full guided bathroom-remodel flow from scope to synthesis.
---

# Workflow — Pipeline (orchestration spine)

Slash-triggered. Runs the strictly-linear stage-gate pipeline. Each stage is its own workflow
(stage-1-scope … stage-8-synthesis); this file is the state machine that sequences them. Full behavior:
constitution + rules. This is the transition-table projection of the orchestration spec.
